...
func main() {
	...
	organizationID := os.Getenv("ZEROXKEY_ORGANIZATION_ID")
	privateKey := os.Getenv("ZEROXKEY_API_PRIVATE_KEY")

	if rpcURL == "" || signWith == "" || organizationID == "" || privateKey == "" {
		log.Fatal("RPC_URL, SIGN_WITH, ZEROXKEY_ORGANIZATION_ID, and ZEROXKEY_API_PRIVATE_KEY must be set")
	}

	fromAddress := common.HexToAddress(signWith)

	////////////////////////////////////////////////////////////////////////////
	// 2) Build 0xkey API key + SDK client
	////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////
	// 5) Build 0xkey-compatible unsigned payload
	//
	// 0xkey expects the EIP-1559 unsigned payload as:
	...
	////////////////////////////////////////////////////////////////////////////
	// 6) Sign the transaction via 0xkey SignTransactionV2
	////////////////////////////////////////////////////////////////////////////
	...
	if err != nil {
		log.Fatalf("0xkey signing error: %v", err)
	}
	...
	signedHex := resp.Payload.Activity.
		...
		SignedTransaction
	if signedHex == nil {
		log.Fatal("0xkey returned nil signed transaction")
	}
