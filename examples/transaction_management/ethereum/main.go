// Package main demonstrates transaction management with 0xkey.
//
...
//
// Both actions use 0xkey Gas Station for gas sponsorship by default.
...
func sendETH(client *sdk.Client) error {
	...
	if sponsor {
		...
		// 0xkey resolves the on-chain nonce automatically.
	}
...
// This is optional when sponsor=true (0xkey handles it internally if omitted),
...
// See: https://docs.0xkey.com/signing-automation/gas-station#security
//
