...
func run() error {
	...
	// These artifacts will be used in the next step to ensure that key material is only accessible by 0xkey, and cannot be extracted by any man-in-the-middle (MITM)
	...
	// For other HD wallet paths see https://docs.0xkey.com/concepts/wallets#hd-wallet-default-paths
	path := "m/44'/60'/1'/0/0"
