...
func (o *NOOPCodegenAnchorReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[POST /0xkey-io/api/v1/noop-codegen-anchor] NOOPCodegenAnchor", response, response.Code())
	}
}
...
func (o *NOOPCodegenAnchorOK) Error() string {
	return fmt.Sprintf("[POST /0xkey-io/api/v1/noop-codegen-anchor][%d] nOOPCodegenAnchorOK  %+v", 200, o.Payload)
}
