...
func (m *AuthenticationMethod) validateType(formats strfmt.Registry) error {
...
// ContextValidate validate this authentication method based on the context it is used
...
func (m *AuthenticationMethod) contextValidateType(ctx context.Context, formats strfmt.Registry) error {
