...
// that proves 0xkey operations were executed within a genuine AWS Nitro Enclave.
//
// To learn more about verifying app proofs and boot proofs, see:
// https://docs.0xkey.com/foundations/
package proofs
...
import (
	...
	"github.com/0xkey-io/sdk-go/pkg/proofs/attestation"
)
...
func VerifyAppProofSignature(appProof *models.AppProof) error {
	...
	signingPubKey, err := p256util.ParseUncompressedPoint65(signingPubKeyBytes)
	if err != nil {
		return fmt.Errorf("invalid public key: %w", err)
	}
