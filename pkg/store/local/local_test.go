...
func TestGetKeyDirPathMacOSX(t *testing.T) {
	...
	assert.Equal(t, "/home/dir/.config/0xkey/keys", local.DefaultAPIKeysDir())
	assert.Equal(t, "/home/dir/.config/0xkey/encryption-keys", local.DefaultEncryptionKeysDir())
}
...
func TestGetKeyDirPathUnix(t *testing.T) {
	...
	assert.Equal(t, "/special/dir/0xkey/keys", local.DefaultAPIKeysDir())
	assert.Equal(t, "/special/dir/0xkey/encryption-keys", local.DefaultEncryptionKeysDir())
}
